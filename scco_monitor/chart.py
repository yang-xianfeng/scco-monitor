...
def build_chart_json(intraday, cur_data, cur_ratio) -> str:
    ...
    layout = {
        ...
        "yaxis": {"domain": [0.25, 1], "gridcolor": "#21262d", "zerolinecolor": "#21262d",
                  "title": "价格 (USD)", "side": "right", "automargin": True},
        "yaxis2": {"domain": [0, 0.2], "gridcolor": "#21262d", "zerolinecolor": "#21262d",
                   "title": "成交量", "side": "right", "automargin": True},
...
def build_history_chart_json(daily) -> str:
    ...
    data = [
        {"type": "scatter", "x": dates, "y": copper, "name": "铜价",
         "mode": "lines", "line": {"color": "#ffa726", "width": 2},
         "yaxis": "y", "xaxis": "x",
         "hovertemplate": "%{x}<br>铜价: $%{y:.4f}<extra></extra>"},
        {"type": "scatter", "x": dates, "y": scco, "name": "SCCO 股价",
         "mode": "lines", "line": {"color": "#58a6ff", "width": 2},
         "yaxis": "y2", "xaxis": "x2",
         "hovertemplate": "%{x}<br>SCCO: $%{y:.2f}<extra></extra>"},
        {"type": "scatter", "x": dates, "y": ratio, "name": "相关性系数",
    ...
    layout = {
        ...
        "xaxis": {"showticklabels": False, "gridcolor": "#21262d", "zerolinecolor": "#21262d", "type": "date"},
        "xaxis2": {"matches": "x", "showticklabels": False, "gridcolor": "#21262d", "zerolinecolor": "#21262d"},
        "xaxis3": {"matches": "x", "gridcolor": "#21262d", "zerolinecolor": "#21262d", "type": "date"},
        "yaxis": {"title": "铜价 (USD)", "side": "right", "gridcolor": "#21262d", "zerolinecolor": "#21262d"},
        "yaxis2": {"title": "SCCO (USD)", "side": "right", "gridcolor": "#21262d", "zerolinecolor": "#21262d"},
        "yaxis3": {"title": "系数", "side": "right", "gridcolor": "#21262d", "zerolinecolor": "#21262d"},
        "legend": {"orientation": "h", "y": 1.02, "x": 0, "font": {"size": 10},
                   "bgcolor": "rgba(0,0,0,0)"},
        "hovermode": "x unified",
    }
